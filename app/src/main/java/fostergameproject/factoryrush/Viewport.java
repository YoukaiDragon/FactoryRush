...
//Class to manage the viewable portion of the screen
public class Viewport {
    ...
    //move the viewport
    //called by FactoryView update method to move the viewport with the player
    ...
    //Returns the screen location for an object, based on its world location and the viewport location
    ...
    //Clip objects that are not on screen to save on processing
